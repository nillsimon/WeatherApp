...
public class MainActivity extends AppCompatActivity {
    ...
    private static String SHARED_FREE_NAME = "TestPreferences";
    ...
    private void saveToPreferences(SharedPreferences sharedPref){
        EditText editText = findViewById(R.id.change_city);
        Editable text = editText.getText();

        if(text != null && !text.toString().isEmpty())
            sharedPref.edit().putString(getString(R.string.shared_pref_key_text),
                    text.toString().apply();
            editText.setText("");
    }
